...
/* **********************************************************************************
    ...
    The custom type is "KeypadVA", which means 14 characters plus NULL = 15
...
void MFCustomDevice::attach(uint16_t adrPin, uint16_t adrType, uint16_t adrConfig, bool configFromFlash)
{
    ...
    ********************************************************************************** */
    ...
    if (strcmp(parameter, "KeypadVA") == 0)
        _customType = MY_CUSTOM_DEVICE_1;
    if (strcmp(parameter, "KeypadVA2") == 0)
    ...
    if (_customType == MY_CUSTOM_DEVICE_1) {
        ...
        ********************************************************************************** */
        if (!FitInMemory(sizeof(KeypadVA))) {
        ...
        ********************************************************************************** */
        ...
        _mydevice = new (allocateMemory(sizeof(KeypadVA))) KeypadVA(_pin1, _pin2);
